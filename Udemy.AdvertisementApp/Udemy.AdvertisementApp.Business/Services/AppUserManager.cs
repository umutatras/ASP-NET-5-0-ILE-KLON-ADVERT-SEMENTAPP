    ...
    public class AppUserManager : Service<AppUserCreateDto, AppUserUpdateDto, AppUserListDto, AppUser>, IAppUserService
    {
        ...
        public async Task<IResponse<AppUserCreateDto>> CreateWithroleAsync(AppUserCreateDto dto,int roleId)
        {
            ...
            if (validationResult.IsValid)
            {
                ...
                // başka bir adım await _uow.GetRepository<AppUserRole>().CreateAsync(new AppUserRole
                //{
                //    AppUser=user,
                //    AppRoleId=roleId
                //});
            ...
            return new Response<AppUserCreateDto>(dto, validationResult.ConvertToCustomValdiatonError());
